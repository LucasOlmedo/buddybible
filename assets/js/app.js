...
app.config(function($mdIconProvider, $stateProvider, $urlRouterProvider) {
  ...
  $mdIconProvider
     .defaultIconSet("./assets/svg/avatars.svg", 128)
      ...
      .icon("facebook_box"       , "./assets/svg/facebook-box.svg"                  , 24)
      .icon("favorite"       , "./assets/svg/ic_favorite.svg"                  , 24)
      .icon("favorited"       , "./assets/svg/ic_favorited.svg"                  , 24)
      ...
      .icon("google_plus"       , "./assets/svg/google-plus.svg"                  , 24)
      .icon("google_plus_box"       , "./assets/svg/google-plus-box.svg"                  , 24)
      ...
      .icon("twitter_box"       , "./assets/svg/twitter-box.svg"                  , 24)
